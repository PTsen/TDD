...
public class JpaintInterface extends JFrame 
{
	...
	JMenuItem mAboutMenu = new JMenuItem("A propos",new ImageIcon("images/info.png"));
	...
	private void setupDock()
	{
		...
		{	
			...
			{
				JpaintInterface.this.mZoneDessin.add(texte, BorderLayout.CENTER);
				String textInput = JOptionPane.showInputDialog(null, 
						"Entrez votre texte");
				JpaintInterface.this.texte.setText(textInput);	
			}
		});
